...
import { ResetPasswordForm } from '@/src/features/auth/reset-password/ui'
...
export default function ResetPasswordPage({ params: { locale } }: IProps) {
  unstable_setRequestLocale(locale)

  return (
    <div className="container flex grow flex-col items-center py-40 max-md:py-28">
      <div className="w-full max-w-sm">
        <NextIntlProvider messagesCategories={['ResetPasswordPage']}>
          <ResetPasswordForm />
        </NextIntlProvider>
      </div>
    </div>
